...
export function HeroSection() {
    return (
        <section className="w-full h-full pt-10">
            ...
            <div className="relative flex container px-4 w-full lg:px-34 h-full mx-auto">
                <div className="flex flex-col justify-between w-full h-full">
                    ...
                    <div className="flex w-full items-center space-x-6">
                        <div className="max-w-[223px] max-h-[66px] text-2xl font-medium mr-0">Workflow with Custom AI
                            Tools
                        </div>
                        <div className="flex">
                    ...
                    <div className="flex w-full items-center space-x-6 py-30">
                        ...
                        <div className="flex w-full items-center justify-around">
                            ...
                            <div className="w-full max-w-[266px] font-medium text-2xl">
